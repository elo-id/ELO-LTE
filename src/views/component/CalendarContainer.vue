<template>
  <div class="calendar-container">
    ...
    <h3 class="titletitle">Full Calendar Code :</h3>
    <div class="doc-canvas" v-if="calendarCode">
      <pre><code class="language-bash" v-html="highlightedCalendarCode"></code></pre>
    </div>
  </div>
</template>
