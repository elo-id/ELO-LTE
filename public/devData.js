...
(function() {
  ...
  loadAndExecute('/ix-Contelo/plugin/de.elo.ix.plugin.proxy/wf/apps/pages/appConfig.jsp?id=lte&namespace=elo');
  elo.data = elo.data || {};
...
api.init = function() {
    ...
    connFact.create2(ci, '0', 'eloajadeh', '', null, null, new de.elo.ix.client.AsyncCallback(function (con) {
